...
func KPIFulfillmentCheckResultEntityToKPIFulfillmentCheckResultDTO(kpiFulfillmentCheckResultEntity dbSchema.KPIFulfillmentCheckResultEntity) types.KPIFulfillmentCheckResultDTO {
