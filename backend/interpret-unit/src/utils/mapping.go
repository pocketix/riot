...
func InterpretSDCommandInvocation2SharedModelCommandInvocation(sdCommandInvocation *models.SDCommandInvocation) sharedModel.SDCommandToInvoke {
	return sharedModel.SDCommandToInvoke{
		SDInstanceUID: sdCommandInvocation.DeviceID,
		CommandName:   sdCommandInvocation.CommandDenotation,
