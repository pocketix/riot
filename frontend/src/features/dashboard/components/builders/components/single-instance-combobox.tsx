...
export const SingleInstanceCombobox = forwardRef<HTMLButtonElement, SingleInstanceComboboxProps>(
  ({ onValueChange, value, disabled = false, className, allowClear = false, filter }, ref) => {
