...
export function LineChartBuilder({ onDataSubmit }: LineChartBuilderProps) {
    ...
    const [jsonInput, setJsonInput] = useState(JSON.stringify(chartConfig, null, 2));
            ...
            <div className='flex gap-4 w-full mt-2'>
                <Label className='w-full'>
                        ...
                        <div className='flex items-center gap-2'>
                            ...
                            <Checkbox
                                ...
                                onCheckedChange={(e) => {
                                    // e is a boolean
                                    if (e) {
                                        handleConfigChange('axisBottom', initialChartConfig.axisBottom)
                                    } else {
                    ...
                    <Input
                        ...
                        onChange={(e) => handleConfigChange('axisBottom', { ...chartConfig.axisBottom, legend: e.target.value })}
                        className='w-full'
                    />
                </Label>
            </div>
            <div className='flex gap-4 w-full mt-2'>
                <Label className='w-full'>
                    ...
                    <Input
                        ...
                        onChange={(e) => handleConfigChange('axisLeft', { ...chartConfig.axisLeft, legend: e.target.value })}
                        className='w-full'
                    />
                </Label>
            </div>
