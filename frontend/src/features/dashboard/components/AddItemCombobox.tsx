    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                ...
                >
                    {selectedInstance
                        ? instances?.find((instance) => instance.type.denotation === selectedInstance.type.denotation)?.type.denotation
                        : "Select a device"}
                            ...
                            <CommandGroup>
                                {instances?.map((instance) => (
                                    ...
                                    >
                                        ...
                                        <Check className={cn(
                                            "ml-auto", selectedInstance?.type.denotation === instance.type.denotation ? "opacity-100" : "opacity-0"
                                        )}
                                        />
                                    </CommandItem>
                                ))}
