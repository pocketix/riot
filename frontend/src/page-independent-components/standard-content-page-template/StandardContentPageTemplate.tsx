...
import styles from './StandardContentPageTemplate.module.scss'
...
const genericErrorMessage: string = 'The system encountered an error! ' + 'Consider checking browser console and application logs for more information... ' + 'One can also try to refresh the page as it may help in some cases...'
