// Using responsive variant from pull request : https://github.com/shadcn-ui/ui/pull/3997
// Also added isOpen prop as when used within a popover, the width is not set correctly
...
export type CalendarProps = React.ComponentProps<typeof DayPicker> & { isOpen?: boolean }
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  ...
  const updateCellSize = React.useCallback(() => {
    ...
    setCellSize(width / DAYS_PER_WEEK)
  }, [])
  ...
  }, [props.isOpen, updateCellSize])

  return (
    <div ref={containerRef} className={cn('pt-2', className)}>
      {cellSize && (
        <DayPicker
