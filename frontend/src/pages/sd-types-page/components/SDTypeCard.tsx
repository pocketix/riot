...
const SDTypeCard: React.FC<SDTypeCardProps> = (props) => {
  ...
  return (
    <GenericCardTemplate
      headerContent={
        <>
          <div className={`${deleteButtonDisabled ? 'cursor-default text-gray-400' : 'cursor-pointer'}`} onClick={() => onDeleteHandler()}>
      ...
      bodyContent={
        <>
          ...
          <Collapse in={props.areParametersDisplayed}>
            <div className="mt-2 flex flex-col gap-1 rounded-[5px] border-2 border-gray-500 px-3 py-1">
